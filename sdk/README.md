...
| -------------------------------------------- | --------------------------------------------------------------------- |
| [Getting Started](./docs/getting-started.md) | Install the SDK and ship your first integration in under five minutes |

### Concepts

| Page                                                       | What you'll learn                                        |
| ---------------------------------------------------------- | -------------------------------------------------------- |
| [Concepts Overview](./docs/concepts/README.md)             | The three core abstractions and how they fit together    |
| [Schema Builder](./docs/concepts/schema-builder.md)        | The `S` namespace, runtime validation, and `InferConfig` |
| [Node Types](./docs/concepts/node-types.md)                | Every node type, field by field, with a decision tree    |
| [ExtensionSettings](./docs/concepts/extension-settings.md) | Class lifecycle, `get` / `set` / `onChange` / `getAll`   |

### Hooks

| Page                                         | What you'll learn                                             |
| -------------------------------------------- | ------------------------------------------------------------- |
| [Hooks Overview](./docs/hooks/README.md)     | The four namespaces, execution order, composition             |
| [Validators](./docs/hooks/validators.md)     | All 20 built-in validators with examples                      |
| [Transforms](./docs/hooks/transforms.md)     | All 16 built-in transforms with examples                      |
| [Completers](./docs/hooks/completers.md)     | `c.filePath` and `c.staticList`                               |
| [Display Functions](./docs/hooks/display.md) | `d.color`, `d.badge`, `d.path`, `d.dictEntry`, `d.keybinding` |

### Examples

| Page                                                | Complexity   | What it shows                                         |
| --------------------------------------------------- | ------------ | ----------------------------------------------------- |
| [Weather Widget](./docs/examples/weather-widget.md) | Beginner     | Text, Boolean, Enum; basic validators                 |
| [Code Formatter](./docs/examples/code-formatter.md) | Intermediate | Sections, List with Struct, numeric validation        |
| [AI Assistant](./docs/examples/ai-assistant.md)     | Advanced     | Nested sections, Dict, `InferConfig`, full hook stack |

### Reference

| Page                                          | Use when                                          |
| --------------------------------------------- | ------------------------------------------------- |
| [API Reference](./docs/reference/api.md)      | You want the full list of exports at a glance     |
| [Type Reference](./docs/reference/types.md)   | You need the exact TypeScript signature of a type |
| [Error Reference](./docs/reference/errors.md) | You need to catch a specific error class          |

---

## Quick links

- Landing an extension? Start with [Getting Started](./docs/getting-started.md).
- Already know the basics? Jump to the [API Reference](./docs/reference/api.md).
- Looking for a specific hook? Try the [Hooks Overview](./docs/hooks/README.md).
- Debugging a runtime error? See the [Error Reference](./docs/reference/errors.md).
